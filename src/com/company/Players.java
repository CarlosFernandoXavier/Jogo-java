...
/**
 * The Class that contains all the variables and stats of the players graphically and mathematically. It also draws the image of the player.
 * 
...
public class Players {
	/**
	 * x - the int that is used to indicate the x position of the player on screen
	 * y - the int that is used to indicate the y position of the player on screen
	 * height - the int that is used to store the height value of the image
	 * width - the int that is used to store the width value of the image
	 * direction - the int that is used to store the direction of the player (0 means right, 1 means left)
	 * imgBullet - the imageIcon containing the image of the player
	 * imgDeadPlayer - the imageIcon containing the image of the dead player
	 * isDead - the boolean telling whether the player is dead
	 * health - the int showing the health of the player
	 * energy - the int showing the energy of the player
	 */
	...
	public Players() {
		x = 0;
		y = 0;
		imgPlayer = new ImageIcon(getClass().getResource("emoji1.png"));
		imgDeadPlayer = new ImageIcon(getClass().getResource("rip.png"));
		isDead = false;
	...
	/**
	 * The method that is used to draw the player depending on whether the player is dead
	 * 
	 ...
	 * 
	 * @param  - the int used to set the y coordinate of the object on screen
	 */
	 ...
	 * 
	 * @return isDead - the boolean setting the boolean that states whether the player is dead (isDead)
	 */
