...
public class Game extends JPanel implements ActionListener, KeyListener {
	...
	public Game() {
		...
		lblInstructions.setFont(new Font("Arial Black", Font.BOLD, 25));
		...
		// set the player2 to the side of the screen with a different image to distinguish easily
		bullet2 = new Bullet();
		player2 = new Players();
		player2.setImage(new ImageIcon(getClass().getResource("emoji2.png")));
		player2.setX(1200);
		...
		lblAngle.setBounds(87, 100, 20, 10);
	 ...
	 * 
	 * @param player
	 *            the player that shoots the bullet
	 * @param bullet
	 *            the bullet which the player shoots
	 */
	 ...
	 * @param player
	 *            the player that carries the bullet
	 */
