...
public class Bullet {
	/**
	 * x - the int that is used to indicate the x position of the weapon on screen
	 * y - the int that is used to indicate the y position of the weapon on screen
	 ...
	 * defense - the int that is used to store the value of the defense of the weapon
	 * energy - the int used to store the maximum energy of the player
	 * explode - the int used to store the explosion radius of the explosion
	 * imgBullet - the imageIcon containing the image of the bullet
	 * shot - the boolean telling whether the bullet is projected
	 */
	 ...
	 * 
	 * @param attack - the int that is used to set the attack stats of the weapon
	 */
	 ...
	 * 
	 * @param defense - the int that is used to set the defense stats of the weapon
	 */
	 ...
	 * 
	 * @return explode - the int that shows the explosion radius that the weapon will create
	 */
	 ...
	 * 
	 * @param explode - the int that is used to set the explosion radius that the weapon will create
	 */
	 ...
	 *  
	 * @return energy - the int that is used to get the maximum energy of the player
	 */
	 ...
	 * 
	 * @param energy - the int that is used to set the maximum energy of the player 
	 */
